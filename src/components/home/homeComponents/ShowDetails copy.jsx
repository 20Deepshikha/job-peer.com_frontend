        ...
        {!editmode ? (
          <div className="detail-mode">
            <div className="detail-btn">
              <button className="detail-edit" onClick={handleEditClick}>
                Edit Job
              </button>
            ...
            <div className="details">
              <p className="status">
                Application Status: <span>{getApplicationStatus()}</span>
              </p>
              ...
              <p className="date-applied">
                ...
                <br />
                {new Date(job.job_applied_date).toLocaleString()}
              </p>
              <hr></hr>
              <p className="job-link">
                <span>Job Applied Link </span>
                <br />
                <a
                  href={job.job_applied_link}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  {job.job_applied_link}
                </a>
              </p>
            </div>
          </div>
          ...
          <div class="edit-form">
            ...
            <input
              class="edit-input"
              type="text"
              value={editJob.job_applied_link}
              onChange={(e) => handleInputChange(e, "job_applied_link")}
